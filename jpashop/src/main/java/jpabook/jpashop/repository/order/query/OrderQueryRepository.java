...
public class OrderQueryRepository {
    ...
    private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds) {
        ...
        List<OrderItemQueryDto> orderItems = em.createQuery(jpql, OrderItemQueryDto.class).setParameter("orderIds", orderIds).getResultList();
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        String jpql = "select new jpabook.jpashop.repository.order.query.OrderFlatDto(o.id, m.name, o.orderDate, o.status, d.address, i.name, oi.orderPrice, oi.count) "
            + "from Order o "
            + "join o.member m "
            + "join o.delivery d "
